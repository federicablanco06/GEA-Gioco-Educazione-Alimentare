...
\author{%
  \alignauthor{%
    ...
    \affaddr{Politecnico di Milano}\\
    \email{giulia1.pennati@mail.polimi.it} } \vfil \alignauthor{%
    \textbf{Nicolò Messina}\\
    \affaddr{Politecnico di Milano}\\
    \email{nicolo.messina@mail.polimi.it} }%\alignauthor{%
    %\textbf{Sixth Author}\\
...
%    \vfil
    ...
    \affaddr{Politecnico di Milano}\\
    \email{vito.matarazzo@mail.polimi.it}}\vfil \alignauthor{% \\
    \textbf{Franca Garzotto}\\    
    \affaddr{Politecnico di Milano}\\
    \email{franca.garzotto@mail.polimi.it}} 
    %}\alignauthor{%
